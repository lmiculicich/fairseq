...
class GlobalSelfAttention(nn.Module):
    ...
    * Bahdanau Attention (mlp):
    ...
    """
    def __init__(self, dim, coverage=False, attn_type="general", attn_hidden=0):
    ...
    def forward(self, input, memory_bank, memory_mask=None, coverage=None):
        """
        ...
        mask = memory_mask#sequence_mask(memory_lengths)
        ...
        align.data.masked_fill_(1 - mask, -float(-1e18))
